                    ...
                    if (textRuns.length > 0) {
                        paragraphs.push(
                            new Paragraph({
                                children: textRuns,
                                spacing: {
                                    before: inList ? 100 : DOCK_STYLES.spacing.paragraph,
            ...
            new Paragraph({
                children: [
                    new TextRun({
                        ...
                        bold: true,
                        font: DOCK_STYLES.fonts.heading,
                        size: DOCK_STYLES.sizes.titles * 2,
                        color: "1A202C",
                    }),
                ],
                alignment: AlignmentType.CENTER,
                ...
                new Paragraph({
                    children: [
                        new TextRun({
                            text: book.subtitle,
                            font: DOCK_STYLES.fonts.heading,
                            size: DOCK_STYLES.sizes.subtitles * 2,
                            color: "4A5568",
                        }),
                    ],
                    alignment: AlignmentType.CENTER,
            ...
            new Paragraph({
                children: [
                    new TextRun({
                        text: `by ${book.author}`,
                        font: DOCK_STYLES.fonts.heading,
                        size: DOCK_STYLES.sizes.author * 2,
                        color: "2D3748",
                    }),
                ],
                alignment: AlignmentType.CENTER,
                    ...
                    new Paragraph({
                        children: [
                            new TextRun({
                                ...
                                bold: true,
                                font: DOCK_STYLES.fonts.heading,
                                size: DOCK_STYLES.sizes.chapterTitle * 2,
                                color: "1A202C",
                            }),
                        ],
                        spacing: {
                            before: DOCK_STYLES.spacing.chapterBefore,
                            after: DOCK_STYLES.spacing.chapterAfter,
                        },
                    })
                );
                const contentParagraphs = processMarkdown(chapter.content || "");
...
// Typography configuration for modern ebook style
const TYPOGRAPHY = {
    fonts: {
        serif: "Times-Roman",
