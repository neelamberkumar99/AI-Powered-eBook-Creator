      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {TESTIMONIALS.map((testimonial, index) => {
                <div
                 key={index}
                  className="group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8  border border-gray-200 hover:border-violet-200  hover: shadow-violet-2xl hover: shadow-violet-500/10  transition-all duration-300 hover:-translate-y-1">
                    {/*quote icon*/}
